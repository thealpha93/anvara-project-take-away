export default function MarketplaceLoading() {
  return (
    <div className="space-y-6">
      <div>
        <div className="mb-1 h-8 w-36 animate-pulse rounded bg-slate-300 dark:bg-slate-600" />
        <div className="h-4 w-64 animate-pulse rounded bg-slate-300 dark:bg-slate-600" />
      </div>

      <div className="flex flex-wrap gap-3">
        <div className="h-10 w-32 animate-pulse rounded-lg bg-slate-300 dark:bg-slate-600" />
        <div className="h-10 flex-1 animate-pulse rounded-lg bg-slate-300 dark:bg-slate-600" />
      </div>
